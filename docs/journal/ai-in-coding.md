...
My name is Harjeet. I started learning how to code when I was 13. For many years I thought that programming would become my career - but university has made me hate coding in so many ways that I actually quit, and became a yoga teacher instead. However, life has a funny way of circling back to the beginning. I got back into coding because somehow, despite being way out of the loop, I got a 3-month paid internship offer at a start-up that was just too good to miss out on. My task wasn’t to learn, it was to use AI to build things from day 1. I was skeptical; I didn’t thing it would work. But it did. Throughout those 3 months, I implemented robust full-stack features, with little to no guidance from anybody. I made mistakes, yes. But I also learned. I began to study independently, slowly understanding the framework I was thrust into. Now I build real software for my yoga business - still learning, but with more confidence than before. Somehow, AI managed to reignite my passion for coding - because at my core, I am a versatile creative who likes to build things, not someone who likes solving puzzles for the sake of the puzzle itself.
